...
لایسنس آتوکس 
"""
    messagebox.showinfo('درباره ما',f"\n\nساخته شده توسط میلاد باصری \n\n{license_text}")
...
filemenu.add_command(label="کپی")
filemenu.add_command(label="چسباندن")
filemenu.add_separator()
filemenu.add_command(label="خروج", command=window.quit)
menubar.add_cascade(label="تغییر", menu=filemenu) 
helpmenu = Menu(menubar , tearoff=0 , bg="black" , fg="white")
helpmenu.add_command(label="درباره من", command=about)
...
expan_btn = PhotoImage(file = r"images/exponent_btn.png")
...
divide = Button(mainFrame , text="/" , fg="black" , image=divideimage , bd=0 , bg="black" , cursor="hand2",
...
multi = Button(mainFrame , text="*" , fg="black" , image=multiimage , bd=0 , bg="black" , cursor="hand2",
...
minus = Button(mainFrame , text="-" , fg="black" , image=minusimage , bd=0 , bg="black" , cursor="hand2",
...
plus = Button(mainFrame , text="+" , fg="black" , image=plusimage , bd=0 , bg="black" , cursor="hand2",
...
equal = Button(mainFrame , text="=" , fg="white" , image=equalimage , bd=0 , bg="black" , cursor="hand2",
...
ee = Button(mainFrame , text="ee" , fg="black" , image=eeimage , bd=0 , bg="black" , cursor="hand2",
